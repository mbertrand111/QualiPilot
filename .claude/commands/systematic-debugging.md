...
1. **Create Failing Test Case**
   ...
   - Use TDD approach (see `/project:test-driven-development`) for writing proper failing tests
...
5. **If 3+ Fixes Failed: Question Architecture**
   ...
   **Discuss with the Tech Lead or a teammate before attempting more fixes**
...
3. **Environment Guards** — Prevent dangerous operations in specific contexts (e.g., refuse destructive ops outside tmpdir in tests)
4. **Debug Instrumentation** — Capture context for forensics (stack traces, logs)
